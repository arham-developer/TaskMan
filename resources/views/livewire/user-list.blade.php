            ...
            <form wire:submit.prevent="submit">
              <div class="row">
                <div class="col-md-12">
                  ...
                  <div class="form-group">
                    <input class="form-control form-control-sm @error('email')is-invalid @enderror" type="text" wire:model="email" placeholder="email">
                  </div>
                  <div class="form-group">
                    <input class="form-control form-control-sm @error('password')is-invalid @enderror" type="password" wire:model="password" placeholder="password">
                  </div>
                  <div class="form-group">
                    <label for="about">About</label>
                    <textarea wire:model="about" class="form-control form-control-sm @error('about')is-invalid @enderror" id="about" rows="2"></textarea>
                  </div>
                  <div class="form-group">
                    <input class="form-control form-control-sm @error('location')is-invalid @enderror" type="text" wire:model="location" placeholder="location">
                  </div>
              ...
              <table class="table">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="text-sm">{{ $item->phone ?? 'not set' }}</td>
                    <td class="text-sm">{{ $item->location ?? 'not set' }}</td>
